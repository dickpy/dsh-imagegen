...
export const DEFAULT_IMAGE_MODELS = ['gpt-image-2.5', 'gpt-image-2', 'grok-imagine-image', 'nanobanana2', 'nanobanana2-lite', 'nanobanana-pro', 'seedream-5.0-pro', 'glm-image'] as const
