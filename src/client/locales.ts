...
export const zh = {
  ...
  'canvas.title': '无限画布 · 标注改图',
  'canvas.add': '添加图片',
  'canvas.empty': '画布还是空的：添加历史 / 画廊图片，或直接拖入本地图片',
  'canvas.toolSelect': '选择 / 移动',
  'canvas.toolRect': '矩形标注',
  'canvas.toolArrow': '箭头标注',
  'canvas.toolBrush': '画笔标注',
  'canvas.toolText': '文字标注',
  'canvas.color': '标注颜色',
  'canvas.undo': '撤销上一笔',
  'canvas.clearAnnotations': '清空标注',
  'canvas.zoomIn': '放大',
  'canvas.zoomOut': '缩小',
  'canvas.zoomReset': '重置缩放',
  'canvas.fit': '适配全部内容',
  'canvas.resizeHint': '拖拽调整大小',
  'canvas.annotate': '标注此图',
  'canvas.remove': '从画布移除',
  'canvas.textPlaceholder': '输入文字，回车确认',
  'canvas.markNotePlaceholder': '这处标注要改什么？回车确认（可留空）',
  'canvas.pickerEmpty': '这里还没有图片',
  'canvas.sendTo': '发送到画布',
  'canvas.selectFirst': '先在画布上点选一张图片',
  'canvas.instructionPlaceholder': '描述要怎么改，例如：把箭头指着的背景换成黄昏海滩',
  'canvas.instructionRequired': '请先输入修改指令',
  'canvas.submit': '标注改图',
  'canvas.globalPlaceholder': '整体要求（可选），例如：整体调成胶片质感',
  'canvas.submitSummary': '将改图 {count} 张 · 共 {marks} 处标注',
  'canvas.noTargets': '在图片上画标注（或点选图片），即可开始改图',
  'canvas.markHint': '已选中一处标注：Delete 删除，双击改说明',
  'canvas.submitCount': '标注改图（{count} 张）',
  'canvas.flattenUnsupported': '当前环境不支持画布导出（缺少 2D 画布支持）',
  ...
  'settings.storageSyncGallery': '同步画廊图片',
  'settings.storageSyncGalleryHint': '加入画廊的图片自动上传',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'canvas.title': 'Infinite canvas · annotate & edit',
  'canvas.add': 'Add images',
  'canvas.empty': 'The canvas is empty: add history / gallery images or drop local files',
  'canvas.toolSelect': 'Select / move',
  'canvas.toolRect': 'Rectangle',
  'canvas.toolArrow': 'Arrow',
  'canvas.toolBrush': 'Brush',
  'canvas.toolText': 'Text',
  'canvas.color': 'Annotation color',
  'canvas.undo': 'Undo last mark',
  'canvas.clearAnnotations': 'Clear marks',
  'canvas.zoomIn': 'Zoom in',
  'canvas.zoomOut': 'Zoom out',
  'canvas.zoomReset': 'Reset zoom',
  'canvas.fit': 'Fit content',
  'canvas.resizeHint': 'Drag to resize',
  'canvas.annotate': 'Annotate this image',
  'canvas.remove': 'Remove from canvas',
  'canvas.textPlaceholder': 'Type text, press Enter',
  'canvas.markNotePlaceholder': 'What should change here? Enter to confirm (optional)',
  'canvas.pickerEmpty': 'No images here yet',
  'canvas.sendTo': 'Send to canvas',
  'canvas.selectFirst': 'Select an image on the canvas first',
  'canvas.instructionPlaceholder': 'Describe the edit, e.g. replace the background at the arrow with a sunset beach',
  'canvas.instructionRequired': 'Type an edit instruction first',
  'canvas.submit': 'Annotate & edit',
  'canvas.globalPlaceholder': 'Overall note (optional), e.g. grade everything like film',
  'canvas.submitSummary': '{count} image(s) · {marks} mark(s)',
  'canvas.noTargets': 'Draw marks on an image (or click one) to start editing',
  'canvas.markHint': 'Mark selected: Delete removes, double-click edits the note',
  'canvas.submitCount': 'Annotate & edit ({count})',
  'canvas.flattenUnsupported': 'Canvas export is unavailable in this environment (no 2D canvas support)',
...
export const ru: Record<keyof typeof zh, string> = {
  ...
  'canvas.title': 'Бесконечный холст · разметка и правка',
  'canvas.add': 'Добавить картинки',
  'canvas.empty': 'Холст пуст: добавьте картинки из истории / галереи или перетащите файлы',
  'canvas.toolSelect': 'Выбор / перемещение',
  'canvas.toolRect': 'Прямоугольник',
  'canvas.toolArrow': 'Стрелка',
  'canvas.toolBrush': 'Кисть',
  'canvas.toolText': 'Текст',
  'canvas.color': 'Цвет разметки',
  'canvas.undo': 'Отменить последнюю метку',
  'canvas.clearAnnotations': 'Убрать все метки',
  'canvas.zoomIn': 'Приблизить',
  'canvas.zoomOut': 'Отдалить',
  'canvas.zoomReset': 'Сбросить масштаб',
  'canvas.fit': 'Вписать содержимое',
  'canvas.resizeHint': 'Потяните, чтобы изменить размер',
  'canvas.annotate': 'Разметить картинку',
  'canvas.remove': 'Убрать с холста',
  'canvas.textPlaceholder': 'Введите текст, Enter — готово',
  'canvas.markNotePlaceholder': 'Что изменить здесь? Enter — подтвердить (необязательно)',
  'canvas.pickerEmpty': 'Здесь пока нет картинок',
  'canvas.sendTo': 'На холст',
  'canvas.selectFirst': 'Сначала выберите картинку на холсте',
  'canvas.instructionPlaceholder': 'Опишите правку, например: замените фон у стрелки на вечерний пляж',
  'canvas.instructionRequired': 'Сначала введите инструкцию',
  'canvas.submit': 'Правка по разметке',
  'canvas.globalPlaceholder': 'Общее требование (необязательно), например: плёночная цветокоррекция',
  'canvas.submitSummary': 'Картинок: {count} · меток: {marks}',
  'canvas.noTargets': 'Нарисуйте метки на картинке (или выберите её), чтобы начать правку',
  'canvas.markHint': 'Метка выбрана: Delete — удалить, двойной клик — изменить описание',
  'canvas.submitCount': 'Правка по разметке ({count})',
  'canvas.flattenUnsupported': 'Экспорт холста недоступен в этом окружении (нет 2D-канвы)',
